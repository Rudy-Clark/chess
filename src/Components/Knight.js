...
const Knight = ({ classes }) => (
  <SvgIcon color="primary" className={classes.root}>
    <g>
      <g>
        <path
          d="M439.208,162.493c-42.656-33.504-84.672-66.976-127.168-100.48c-18.432-14.176-27.392-32.192-23.648-55.488
    ...
    <g>
      <g>
        <path
          d="M414.312,488.861l-32-64.032c-2.72-5.408-8.256-8.832-14.304-8.832h-256c-6.048,0-11.584,3.424-14.304,8.832l-32,64
